...
export default function MbtiOverview({ onStartTest, lang = 'vi' }) {
  ...
  return (
    <div className="max-w-4xl mx-auto py-6 space-y-8 animate-fade-in">
      ...
      {/* HEADER HERO */}
      <div className="bg-gradient-to-r from-slate-950 via-blue-950 to-teal-900 rounded-3xl p-6 sm:p-10 text-white shadow-2xl border border-teal-400/40 relative overflow-hidden text-center sm:text-left space-y-6">
        ...
        <h1 className="text-2xl sm:text-4xl font-black tracking-tight leading-tight">
          Khám Phá <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-300 via-cyan-200 to-white">16 Nhóm Tính Cách MBTI</span> Thực Chiến
        </h1>
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-4">
          ...
          <span className="text-xs text-teal-200 font-semibold flex items-center space-x-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-extrabold text-sm text-teal-700 dark:text-teal-400">1. Nguồn Năng Lượng</span>
              <span className="px-2 py-0.5 bg-teal-100 dark:bg-teal-950 text-teal-800 dark:text-teal-300 font-black text-xs rounded">E vs I</span>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-extrabold text-sm text-cyan-700 dark:text-cyan-400">2. Thu Thập Thông Tin</span>
              <span className="px-2 py-0.5 bg-cyan-100 dark:bg-cyan-950 text-cyan-800 dark:text-cyan-300 font-black text-xs rounded">S vs N</span>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-extrabold text-sm text-slate-900 dark:text-slate-200">3. Cách Ra Quyết Định</span>
              <span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 font-black text-xs rounded">T vs F</span>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-extrabold text-sm text-emerald-700 dark:text-emerald-400">4. Phong Cách Lối Sống</span>
              <span className="px-2 py-0.5 bg-emerald-100 dark:bg-emerald-950 text-emerald-800 dark:text-emerald-300 font-black text-xs rounded">J vs P</span>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
